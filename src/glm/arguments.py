...
def add_training_args(parser):
    ...
    group.add_argument('--task-dataset', type=str, help="The task dataset's name")
    return parser
...
def add_text_generate_args(parser):
    ...
    group.add_argument("--num-beams", type=int, default=8)
...
def add_data_args(parser):
    ...
    group.add_argument("--cache-dir", default="/workspace/pytorch_cache/", type=str,
